...
$sql="INSERT INTO   tblbdonor(Name,Email,MobileNumber,City,Location,Age,Bgroup) VALUES(:name,:email,:mobile,:city,:location,:age,:bgroup)";
      ...
      <div class="images">
          ...
          <div class="row">
              ...
              <div class="col-md-12">
                  ...
                  <h1 class="admin-heading">Donor Registation</h1>
              </div>
