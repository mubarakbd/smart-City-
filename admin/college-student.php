...
<div class="tables">
   <table class="contant-table">
	...
	<tbody>
						...
						$sql = "SELECT * from  tblapplycollege WHERE College LIKE '%$keyword%' ";
						...
						{				?>	
                          <tr>
                            ...
                            <td><?php echo htmlentities($result->ssce_xamyear);?></td>
                            <td><?php echo htmlentities($result->Dept);?></td>
                            <td><?php echo htmlentities($result->GPA);?></td>	
				...
				<a onclick="return confirm('Are you sure ?')" href='delete-studentlist.php?id=<?php echo htmlentities($result->id);?>'><i class='fa fa-trash-o'></i></a></td>
...
<table class="contant-table">
	...
	<tbody>
		<?php $sql = "SELECT * from  tblapplycollege";
			$query = $dbh -> prepare($sql);
